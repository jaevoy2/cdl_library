...
export default function Index() {
    return (
        <>
            <Image source={school} resizeMode='cover' style={{ position: 'absolute', width, height, bottom: 0, zIndex: -1, opacity: 0.7 }} />
            <LinearGradient
                colors={['#1871ac', 'rgba(52, 152, 219, 0.9)', 'rgba(52, 152, 219, 0.83)', '#d4c94ed7']}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
