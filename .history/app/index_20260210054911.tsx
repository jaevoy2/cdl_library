    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            ...
            <View style={{ height, zIndex: 15 }}>
                <BottomSheet ref={bottomSheetRef} snapPoints={sheetSnapPoints} index={0} bottomInset={0} enableHandlePanningGesture={false} enableContentPanningGesture={false}  handleIndicatorStyle={{ display: 'none' }}>
