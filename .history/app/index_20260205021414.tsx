        ...
        <View style={{ paddingHorizontal: 20 }}>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', height, gap: '40', zIndex: 10 }}>
                ...
                <View style={{ flexDirection: 'column', alignItems: 'center', gap: 20, width: '100%' }}>
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, borderColor: '#FBE704', borderWidth: 1, borderRadius: 50, padding: 10, width: '100%' }}>
