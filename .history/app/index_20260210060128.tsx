                ...
                <View style={{paddingTop: 170, alignItems: 'center', height, gap: '40', zIndex: 10 }}>
                    ...
                    <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height: height - 280, transform: [{ translateY: translateY }], backgroundColor: '#FAFAFA', borderTopLeftRadius: 30, borderTopRightRadius: 30, zIndex: 5, paddingHorizontal: 25, paddingTop: 30 }}>
                        ...
                        <View style={{ flex: 1, position: 'relative' }}>
                            <TouchableOpacity disabled={otpSpinner} style={{ backgroundColor: otpSpinner == true ? '#5faee2ff' : '#3498db', width: width - 20, borderRadius: 30, paddingVertical: 12, position: 'absolute', bottom: 60, left: '50%', transform: [{ translateX: '-50%' }] }}>
                            {otpSpinner == true ? (
                            ...
                            <TouchableOpacity style={{ position: 'absolute', bottom: 25, left: '50%', transform: [{ translateX: '-50%' }] }}>
