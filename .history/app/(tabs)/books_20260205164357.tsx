            ...
            <View style={{ paddingTop: 20, paddingHorizontal: 20 }}>
                <View style={{ paddingLeft: 8, borderWidth: 1, borderColor: '#afafaf', backgroundColor: '#eeeded', flexDirection: 'row', justifyContent: 'space-between', borderRadius: 50 }}>
                    <TextInput onChangeText={() => setOnSearch(true)} style={{ width: '90%' }} placeholder="Search" />
                        <View style={{ borderLeftWidth: 1, borderLeftColor: '#afafaf', justifyContent: 'center', paddingLeft: 5, backgroundColor: '#9e9d9d', borderTopEndRadius: 50, borderBottomEndRadius: 50, width: '100%' }}>
                            {onSearch  == true ? (
