    ...
    return (
        <View>
            ...
            <View style={{ paddingTop: 20, paddingHorizontal: 20 }}>
                <View style={{ paddingHorizontal: 8, borderWidth: 1, borderColor: '#afafaf', backgroundColor: '#e6e6e6', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 50 }}>
