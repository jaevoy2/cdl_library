...
export default function Index() {
    ...
    const [request, response, prompAsync] = Google.useAuthRequest({
        androidClientId: "446081453845-tennvj0cbo0nvlb0o704de4c89a8a9r3.apps.googleusercontent.com",
        ...
        <View style={{ paddingHorizontal: 20 }}>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', height, gap: '40', zIndex: 10 }}>
                ...
                <View style={{ flexDirection: 'column', alignItems: 'center', gap: 20, width: '100%' }}>
                    <Text style={{ color: '#fff', fontSize: 18, fontWeight: '900', letterSpacing: 2 }}>{JSON.stringify(userInfo)}</Text>
