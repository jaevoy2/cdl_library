...
export default function Index() {
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: height - 200, zIndex: 20 }}>
                <BottomSheet ref={bottomSheetRef} snapPoints={sheetSnapPoints} index={1} bottomInset={1} enableHandlePanningGesture={false} enableContentPanningGesture={false}  handleIndicatorStyle={{ display: 'none' }}>
